...
def build_argparser():
    ...
    args.add_argument("-m", "--model", default="face_detection.xml", 
                      help="Required. Path to an .xml file with a trained model.",
                      type=str)
    args.add_argument("-i", "--input", default="cam",
...
def main():
    ...
    # Read IR
    log.info("Loading network files:\t{}".format(model_xml))
    ...
    if args.input == 'cam': input_stream = 0
    else: input_stream = args.input
