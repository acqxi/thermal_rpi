...
config.set('stereo', 'startX', str(startX))
config.set('stereo', 'startY', str(startY))
config.set('stereo', 'endX',   str(endX))
config.set('stereo', 'endY',   str(endY))
config.write(open('../fusion.conf', 'w'))
